	...
	function kasutan_setup() {
		...
		*/
		add_theme_support( 'editor-font-sizes', array(
			array(
				'name' => __( 'Petite', 'improutes' ),
				'size' => 13,
				'slug' => 'small'
			),
			array(
				'name' => __( 'Normale', 'improutes' ),
				'size' => 16,
				'slug' => 'normal'
			),
			array(
				'name' => __( 'Grande', 'improutes' ),
				'size' => 25,
				'slug' => 'big'
			),
			array(
				'name' => __( 'Très grande', 'improutes' ),
				'size' => 32,
				'slug' => 'huge'
			)
		) );
...
function kasutan_scripts() {
	wp_enqueue_style( 'improutes-owl-carousel', get_template_directory_uri() . '/lib/owlcarousel/owl.carousel.min.css',array(),'2.3.4');
	wp_enqueue_style( 'improutes-style', get_stylesheet_uri(),array(), filemtime( get_template_directory() . '/style.css' ) );
	...
	wp_enqueue_script( 'improutes-navigation', get_template_directory_uri() . '/js/min/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'improutes-skip-link-focus-fix', get_template_directory_uri() . '/js/min/skip-link-focus-fix.js', array(), '20151215', true );

	wp_enqueue_script( 'improutes-owl-carousel',get_template_directory_uri() . '/lib/owlcarousel/owl.carousel.min.js', array('jquery'), '2.3.4', true );

	wp_enqueue_script( 'improutes-scripts', get_template_directory_uri() . '/js/min/main.js', array('jquery','improutes-owl-carousel'), '', true );

	//scripts pour le filtre des actus
	if(is_home()) {
		wp_enqueue_script( 'improutes-listjs', get_template_directory_uri() . '/lib/list/list.min.js', array(), '1.0', true );
		wp_enqueue_script( 'improutes-filtre', get_template_directory_uri() . '/js/min/filtre.js', array('jquery','improutes-listjs'), filemtime( get_template_directory() . '/js/min/filtre.js'), true );
	}
}
